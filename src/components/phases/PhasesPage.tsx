                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-500">
                        {/* عداد المهام المنجزة/الإجمالي لكل مرحلة */}
                        {
                          (() => {
                            ...
                            return `${completedTasks}/${totalTasks} ${lang === 'ar' ? safeT('tasks') : safeT('tasks')}`;
                          })()
                        }
                      </div>
                      <div className="text-xs text-gray-500 dark:text-gray-500">
                        {completion.completedWeeks}/{completion.totalWeeks} {safeT('weeks') || 'أسابيع'}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500 dark:text-gray-500">{safeT('duration') || 'المدة'}:</span>
                        <span className="font-medium">{phase.duration}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500 dark:text-gray-500">{safeT('level') || 'المستوى'}:</span>
