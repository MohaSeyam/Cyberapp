            ...
            {week.days?.filter(day => day.key !== 'fri').map((day, dayIndex) => {
              ...
              return (
                <motion.div 
                  ...
                  className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer hover:shadow-lg border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600`}
